...
public class SlownessEnchant extends Enchantment {
    ...
    public SlownessEnchant(Enchantment.Rarity pRarity, EnchantmentType pCategory, EquipmentSlotType... pApplicableSlots) {
    ...
    public void onEntityDamaged(LivingEntity pAttacker, Entity pTarget, int pLevel) {
        if(pTarget instanceof LivingEntity){
            ((LivingEntity) pTarget).addPotionEffect(new EffectInstance(Effects.SLOWNESS, 20*pLevel, pLevel - 1));
        }
